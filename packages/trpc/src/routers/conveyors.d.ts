export declare const employeesRouter: import("node_modules/@trpc/server/dist/unstable-core-do-not-import.d-Dh9CT5RO.cjs").BuiltRouter<{
    ctx: {
        employeesService: import("..").IEmployeesService;
    };
    meta: object;
